...
#
# Adapted from the Conan Center recipe for freetype (MIT). Upstream's build is kept as it
...
class FreetypeConan(ConanFile):
    ...
    def validate(self):
        if str(self.settings.os) not in ("Windows", "Linux", "Macos", "Android", "iOS"):
            raise ConanInvalidConfiguration(f"freetype is not shipped for {self.settings.os}")
