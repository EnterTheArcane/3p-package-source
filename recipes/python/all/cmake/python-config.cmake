...
set(PY_BASE_DIR ${CMAKE_CURRENT_LIST_DIR}/python/Python.framework/Versions/3.10)
...
if (PAL_PLATFORM_NAME STREQUAL "Mac")
    ...
    # Guarded so the package also resolves outside the engine.
    if (COMMAND ly_target_include_system_directories)
        ly_target_include_system_directories(TARGET ${TARGET_WITH_NAMESPACE} INTERFACE ${${MY}_INCLUDE_DIR})
    else()
        target_include_directories(${TARGET_WITH_NAMESPACE} SYSTEM INTERFACE ${${MY}_INCLUDE_DIR})
    endif()
