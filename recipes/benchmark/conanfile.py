...
#
# Adapted from the Conan Center recipe for benchmark (MIT). Upstream's build is kept as it
...
class BenchmarkConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property("cmake_file_name", "GoogleBenchmark")
